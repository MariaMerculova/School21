...
**GET**/api/v1/new-year/recipes  -  список рецертов

**POST**/api/v1/new-year/recipes  -  создать рецепт

**PUT/PATCH**//api/v1/new-year/recipes/{id} -  изменить рецепт

**DELETE**/api/v1/new-year/recipes/{id}  -  удалить рецепт
